...
\title{HPS DAQ Operations Manual v2.3.3}
...
In the runcontrol GUI, click ``File''$\to``$Exit''.  You may have to do that twice.
To be sure that all underlying processes are gone, log into \texttt{clondaq3} as \texttt{clasrun}, be sure you are on the correct host, and then execute the two commands:\newline
