...
\title{HPS DAQ Operations Manual v2.3.7}
...
\item
    Fill out the popup GUI for the run log.  See Figure~\ref{fig:runlog}.
...
\item
    Confirm the run log gui by pressing ``Done'' (see Figure~\ref{fig:runlog}).  Here you have an opportunity to update and overwrite the info given during ``Prestart''.  
